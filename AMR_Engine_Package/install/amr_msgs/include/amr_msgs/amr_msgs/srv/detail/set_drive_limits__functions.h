...
#ifndef AMR_MSGS__SRV__DETAIL__SET_DRIVE_LIMITS__FUNCTIONS_H_
#define AMR_MSGS__SRV__DETAIL__SET_DRIVE_LIMITS__FUNCTIONS_H_
 ...
 * calls
 * amr_msgs__srv__SetDriveLimits_Request__init().
...
/**
 * It calls
 * amr_msgs__srv__SetDriveLimits_Request__fini()
 ...
 * amr_msgs__srv__SetDriveLimits_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * amr_msgs__srv__SetDriveLimits_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * amr_msgs__srv__SetDriveLimits_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_amr_msgs
...
/**
 * It calls
 * amr_msgs__srv__SetDriveLimits_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_amr_msgs
...
/**
 * It allocates the memory for the array and calls
 * amr_msgs__srv__SetDriveLimits_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_amr_msgs
...
/**
 * It calls
 * amr_msgs__srv__SetDriveLimits_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // AMR_MSGS__SRV__DETAIL__SET_DRIVE_LIMITS__FUNCTIONS_H_
