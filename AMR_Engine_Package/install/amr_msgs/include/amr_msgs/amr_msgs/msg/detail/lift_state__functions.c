...
amr_msgs__msg__LiftState__are_equal(const amr_msgs__msg__LiftState * lhs, const amr_msgs__msg__LiftState * rhs)
{
  ...
  for (size_t i = 0; i < 2; ++i) {
    if (lhs->actuator_position[i] != rhs->actuator_position[i]) {
      return false;
    }
  }
  // actuator_current
  for (size_t i = 0; i < 2; ++i) {
    if (lhs->actuator_current[i] != rhs->actuator_current[i]) {
      return false;
    }
  }
  // level_fault
  if (lhs->level_fault != rhs->level_fault) {
    return false;
  }
  return true;
}
  ...
  amr_msgs__msg__LiftState * output)
{
  ...
  // actuator_position
  for (size_t i = 0; i < 2; ++i) {
    output->actuator_position[i] = input->actuator_position[i];
  }
  // actuator_current
  for (size_t i = 0; i < 2; ++i) {
    output->actuator_current[i] = input->actuator_current[i];
  }
  // level_fault
  output->level_fault = input->level_fault;
  return true;
}
