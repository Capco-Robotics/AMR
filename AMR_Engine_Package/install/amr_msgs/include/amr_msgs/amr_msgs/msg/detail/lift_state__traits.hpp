  ...
  std::ostream & out)
{
  ...
  // member: actuator_position
  {
    if (msg.actuator_position.size() == 0) {
      out << "actuator_position: []";
    } else {
      out << "actuator_position: [";
      size_t pending_items = msg.actuator_position.size();
      for (auto item : msg.actuator_position) {
  ...
  // member: actuator_current
  {
    if (msg.actuator_current.size() == 0) {
      out << "actuator_current: []";
    } else {
      out << "actuator_current: [";
      size_t pending_items = msg.actuator_current.size();
      for (auto item : msg.actuator_current) {
        rosidl_generator_traits::value_to_yaml(item, out);
        if (--pending_items > 0) {
          out << ", ";
        }
  ...
  {
    out << "level_fault: ";
    rosidl_generator_traits::value_to_yaml(msg.level_fault, out);
  }
  out << "}";
