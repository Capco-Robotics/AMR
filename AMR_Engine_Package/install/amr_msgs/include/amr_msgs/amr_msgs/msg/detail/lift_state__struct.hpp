...
struct LiftState_
{
  ...
  : header(_init)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      std::fill<typename std::array<float, 2>::iterator, float>(this->actuator_position.begin(), this->actuator_position.end(), 0.0f);
      std::fill<typename std::array<float, 2>::iterator, float>(this->actuator_current.begin(), this->actuator_current.end(), 0.0f);
      this->level_fault = false;
    }
  }
  ...
  : header(_alloc, _init),
    actuator_position(_alloc),
    actuator_current(_alloc)
  {
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
  ...
  using _actuator_position_type =
    std::array<float, 2>;
  _actuator_position_type actuator_position;
  using _actuator_current_type =
    std::array<float, 2>;
  _actuator_current_type actuator_current;
  using _level_fault_type =
    bool;
  _level_fault_type level_fault;
  ...
  Type & set__actuator_position(
    const std::array<float, 2> & _arg)
  {
    this->actuator_position = _arg;
    return *this;
  }
  Type & set__actuator_current(
    const std::array<float, 2> & _arg)
  {
    this->actuator_current = _arg;
    return *this;
  }
  Type & set__level_fault(
    const bool & _arg)
  {
    this->level_fault = _arg;
    return *this;
  }
  ...
  bool operator==(const LiftState_ & other) const
  {
    ...
    if (this->actuator_position != other.actuator_position) {
      return false;
    }
    if (this->actuator_current != other.actuator_current) {
      return false;
    }
    if (this->level_fault != other.level_fault) {
      return false;
    }
    return true;
  }
