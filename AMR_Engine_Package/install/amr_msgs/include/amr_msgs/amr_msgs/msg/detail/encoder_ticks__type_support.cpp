...
{
  new (message_memory) amr_msgs::msg::EncoderTicks(_init);
}

void EncoderTicks_fini_function(void * message_memory)
{
  auto typed_message = static_cast<amr_msgs::msg::EncoderTicks *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember EncoderTicks_message_member_array[4] = {
  {
    ...
    offsetof(amr_msgs::msg::EncoderTicks, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(amr_msgs::msg::EncoderTicks, left_ticks),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(amr_msgs::msg::EncoderTicks, right_ticks),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(amr_msgs::msg::EncoderTicks, dt_ms),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers EncoderTicks_message_members = {
  ...
  4,  // number of fields
  sizeof(amr_msgs::msg::EncoderTicks),
...
get_message_type_support_handle<amr_msgs::msg::EncoderTicks>()
{
  return &::amr_msgs::msg::rosidl_typesupport_introspection_cpp::EncoderTicks_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, amr_msgs, msg, EncoderTicks)() {
  return &::amr_msgs::msg::rosidl_typesupport_introspection_cpp::EncoderTicks_message_type_support_handle;
}
