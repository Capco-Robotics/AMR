...
ENCODER_LEFT_SDA_PIN = 8  # GP4
ENCODER_LEFT_SCL_PIN = 9  # GP5
ENCODER_RIGHT_I2C_ID = 1  # machine.I2C(1, ...)
ENCODER_RIGHT_SDA_PIN = 10   # GP6
ENCODER_RIGHT_SCL_PIN = 11  # GP7
...
# Add these at the end of your config.py
AS5600_ADDR = 0x36
ENCODER_I2C_FREQ = 400000  # 400 kHz standard fast I2C

# Left Encoder (I2C Bus 0)
ENCODER_LEFT_I2C_ID = 0
ENCODER_LEFT_SCL_PIN = 9
ENCODER_LEFT_SDA_PIN = 8

# Right Encoder (I2C Bus 1)
ENCODER_RIGHT_I2C_ID = 1
ENCODER_RIGHT_SCL_PIN = 11
ENCODER_RIGHT_SDA_PIN = 10